...
parser.add_argument('--batch-size',         type=int, default=300, help='input batch size for training (default: 64)')
...
parser.add_argument('--gamma',              type=float, default=0.8, help='decreasing learning rate by gamma (default: 0.1)')
parser.add_argument('--stepvalue',          type=int, default=[40, 70, 80], nargs='+')
parser.add_argument('--no-cuda',            action='store_true', default=False, help='enables CUDA training')
parser.add_argument('--seed',               type=int, default=1, help='random seed (default: 1)')
parser.add_argument('--feat-size',          type=int, default=5, help='how long is the extracted feature vector')
